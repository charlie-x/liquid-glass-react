// src/index.tsx
import { forwardRef, memo, useCallback, useEffect, useId, useLayoutEffect, useRef, useState } from "react";
...
var CrackPattern = memo(({ id, intensity, width, height }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("filter", { id: `${id}-crack-filter`, x: "0%", y: "0%", width: "100%", height: "100%", children: [
          /* @__PURE__ */ jsx("feGaussianBlur", { in: "SourceGraphic", stdDeviation: "0.5", result: "blurred" }),
          /* @__PURE__ */ jsx(
            "feColorMatrix",
            {
              in: "blurred",
          ...
          /* @__PURE__ */ jsx("feComposite", { in: "white", in2: "SourceGraphic", operator: "over" })
        ] }) }),
        cracks.map((crack) => /* @__PURE__ */ jsx(
          "path",
          {
            d: crack.path,
...
var GlassFilter = ({
  ...
  mode,
  shaderMapUrl
}) => /* @__PURE__ */ jsx("svg", { style: { position: "absolute", top: 0, left: 0, width, height, pointerEvents: "none" }, "aria-hidden": "true", children: /* @__PURE__ */ jsxs("defs", { children: [
  /* @__PURE__ */ jsxs("radialGradient", { id: `${id}-edge-mask`, cx: "50%", cy: "50%", r: "50%", children: [
    ...
    /* @__PURE__ */ jsx("stop", { offset: `${Math.max(30, 80 - aberrationIntensity * 2)}%`, stopColor: "black", stopOpacity: "0" }),
    /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: "white", stopOpacity: "1" })
  ] }),
  /* @__PURE__ */ jsxs("filter", { id, x: "-35%", y: "-35%", width: "170%", height: "170%", colorInterpolationFilters: "sRGB", children: [
    ...
    /* @__PURE__ */ jsx("feBlend", { in: "GREEN_CHANNEL", in2: "BLUE_CHANNEL", mode: "screen", result: "GB_COMBINED" }),
    /* @__PURE__ */ jsx("feBlend", { in: "RED_CHANNEL", in2: "GB_COMBINED", mode: "screen", result: "RGB_COMBINED" }),
    /* @__PURE__ */ jsx("feGaussianBlur", { in: "RGB_COMBINED", stdDeviation: Math.max(0.1, 0.5 - aberrationIntensity * 0.1), result: "ABERRATED_BLURRED" }),
    /* @__PURE__ */ jsx("feComposite", { in: "ABERRATED_BLURRED", in2: "EDGE_MASK", operator: "in", result: "EDGE_ABERRATION" }),
    /* @__PURE__ */ jsx("feComponentTransfer", { in: "EDGE_MASK", result: "INVERTED_MASK", children: /* @__PURE__ */ jsx("feFuncA", { type: "table", tableValues: "1 0" }) }),
    /* @__PURE__ */ jsx("feComposite", { in: "CENTER_ORIGINAL", in2: "INVERTED_MASK", operator: "in", result: "CENTER_CLEAN" }),
    /* @__PURE__ */ jsx("feComposite", { in: "EDGE_ABERRATION", in2: "CENTER_CLEAN", operator: "over" })
  ] })
] }) });
var GlassContainer = forwardRef(
  ({
    children,
    className = "",
    style,
...
function LiquidGlass({
  ...
  if (fillContainer) {
    return /* @__PURE__ */ jsxs("div", { style: { ...positionStyles, ...style }, className, children: [
      /* @__PURE__ */ jsx(
        GlassContainer,
        {
          ref: glassRef,
