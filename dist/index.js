...
var CrackPattern = (0, import_react.memo)(({ id, intensity, width, height }) => {
  const r = (n) => Math.round(n * 100) / 100;
  const generateCracks = (intensity2) => {
    const cracks2 = [];
    const numCracks = Math.floor(intensity2 * 8);
    const seed = 12345;
    let randomSeed = seed;
    const seededRandom = () => {
    ...
    for (let i = 0; i < numCracks; i++) {
      ...
      const length2 = r(20 + seededRandom() * (width * 0.3));
      ...
      for (let j = 0; j < segments; j++) {
        const segmentLength = length2 / segments;
      ...
      if (seededRandom() > 0.6) {
        ...
        const branchLength = r(length2 * 0.3);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("filter", { id: `${id}-crack-filter`, x: "0%", y: "0%", width: "100%", height: "100%", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "SourceGraphic", stdDeviation: "0.5", result: "blurred" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComposite", { in: "white", in2: "SourceGraphic", operator: "over" })
        ] }) }),
        cracks.map((crack) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "path",
          {
            d: crack.path,
...
var GlassFilter = ({
  ...
  mode,
  shaderMapUrl
}) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { style: { position: "absolute", top: 0, left: 0, width, height, pointerEvents: "none" }, "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("defs", { children: [
  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("radialGradient", { id: `${id}-edge-mask`, cx: "50%", cy: "50%", r: "50%", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "0%", stopColor: "black", stopOpacity: "0" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: `${Math.max(30, 80 - aberrationIntensity * 2)}%`, stopColor: "black", stopOpacity: "0" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "100%", stopColor: "white", stopOpacity: "1" })
  ] }),
  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("filter", { id, x: "-35%", y: "-35%", width: "170%", height: "170%", colorInterpolationFilters: "sRGB", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feImage", { id: "feimage", x: "0", y: "0", width: "100%", height: "100%", result: "DISPLACEMENT_MAP", href: getMap(mode, shaderMapUrl), preserveAspectRatio: "xMidYMid slice" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "feColorMatrix",
      {
        in: "DISPLACEMENT_MAP",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComponentTransfer", { in: "EDGE_INTENSITY", result: "EDGE_MASK", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feFuncA", { type: "discrete", tableValues: `0 ${aberrationIntensity * 0.05} 1` }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feOffset", { in: "SourceGraphic", dx: "0", dy: "0", result: "CENTER_ORIGINAL" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feDisplacementMap", { in: "SourceGraphic", in2: "DISPLACEMENT_MAP", scale: displacementScale * (mode === "shader" ? 1 : -1), xChannelSelector: "R", yChannelSelector: "B", result: "RED_DISPLACED" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "feColorMatrix",
      {
        in: "RED_DISPLACED",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feDisplacementMap", { in: "SourceGraphic", in2: "DISPLACEMENT_MAP", scale: displacementScale * ((mode === "shader" ? 1 : -1) - aberrationIntensity * 0.05), xChannelSelector: "R", yChannelSelector: "B", result: "GREEN_DISPLACED" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "feColorMatrix",
      {
        in: "GREEN_DISPLACED",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feDisplacementMap", { in: "SourceGraphic", in2: "DISPLACEMENT_MAP", scale: displacementScale * ((mode === "shader" ? 1 : -1) - aberrationIntensity * 0.1), xChannelSelector: "R", yChannelSelector: "B", result: "BLUE_DISPLACED" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "feColorMatrix",
      {
        in: "BLUE_DISPLACED",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feBlend", { in: "GREEN_CHANNEL", in2: "BLUE_CHANNEL", mode: "screen", result: "GB_COMBINED" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feBlend", { in: "RED_CHANNEL", in2: "GB_COMBINED", mode: "screen", result: "RGB_COMBINED" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "RGB_COMBINED", stdDeviation: Math.max(0.1, 0.5 - aberrationIntensity * 0.1), result: "ABERRATED_BLURRED" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComposite", { in: "ABERRATED_BLURRED", in2: "EDGE_MASK", operator: "in", result: "EDGE_ABERRATION" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComponentTransfer", { in: "EDGE_MASK", result: "INVERTED_MASK", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feFuncA", { type: "table", tableValues: "1 0" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComposite", { in: "CENTER_ORIGINAL", in2: "INVERTED_MASK", operator: "in", result: "CENTER_CLEAN" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComposite", { in: "EDGE_ABERRATION", in2: "CENTER_CLEAN", operator: "over" })
  ] })
] }) });
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              ...
              style: {
                ...
                flexDirection: fillContainer ? "column" : void 0,
                width: fillContainer ? "100%" : void 0,
                alignItems: fillContainer ? void 0 : "center",
                gap: fillContainer ? void 0 : "24px",
                padding,
                overflow: "hidden",
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "span",
                  {
                    ...
                    style: {
                      ...backdropStyle,
                      filter: !fillContainer && !isFirefox ? `url(#${filterId})` : void 0,
                      zIndex: 0
                    }
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      zIndex: 1,
                      width: fillContainer ? "100%" : void 0,
                      font: fillContainer ? void 0 : "500 20px/1 system-ui",
...
function LiquidGlass({
  ...
  const crackId = (0, import_react.useId)();
  ...
  const transformStyle = fillContainer ? "none" : `translate(calc(-50% + ${elasticTranslation.x}px), calc(-50% + ${elasticTranslation.y}px)) ${isActive && Boolean(onClick) ? "scale(0.96)" : calculateDirectionalScale()}`;
  const baseStyle = {
    ...style,
    transform: transformStyle,
    transition: fillContainer ? void 0 : "all ease-out 0.2s"
  };
  const positionStyles = fillContainer ? {
    position: "relative",
    width: "100%"
  } : {
  ...
  if (fillContainer) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...positionStyles, ...style }, className, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        GlassContainer,
        {
          ref: glassRef,
      ...
      cracks > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
          style: {
            position: "absolute",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    Boolean(onClick) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
          style: {
